...
export const sourcePages: readonly SourcePageBrief[] = [
  ...
  {
    path: '/services', eyebrow: 'Services', title: 'Specialist support for the work behind your business.',
    summary: 'Explore the complete Virtual Office Angels service range and find the capability that fits your team, systems, and priorities.', template: 'services',
  },
