...
export const sourcePages: readonly SourcePageBrief[] = [
  ...
  {
    path: '/services', eyebrow: 'Services', title: 'The right expertise for the work that keeps your business moving.',
    summary: 'Explore specialist support for finance, property, operations, marketing, sales, creative work, and technology.',
    template: 'services',
  },
