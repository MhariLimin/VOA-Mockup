...
export const sourcePages: readonly SourcePageBrief[] = [
  ...
  {
    path: '/about', eyebrow: 'About us', title: 'About Virtual Office Angels',
    summary: 'We work with Australian businesses that need capable, experienced virtual assistants who can contribute from day one. Whether the role is specialised or operational, we focus on finding support that fits the work and how your business runs.',
  ...
  service('/services/insurance-processing', 'Insurance Processing Virtual Support', 'Virtual Office Angels matches insurance businesses with experienced virtual assistants who support policy administration, renewals, claims processing, and client records within your systems and documented procedures.', [], [], 'staging', '/assets/source/staging/images/58c3c928d3-2147694521.jpg'),
  ...
  { path: '/how-it-works', eyebrow: 'How it works', title: 'A clear path from role brief to managed support.', summary: 'Virtual Office Angels handles recruitment and matching, then stays involved through onboarding and the ongoing working relationship.', template: 'process' },
  {
    ...
    summary: 'Build a specialised virtual assistant role around the work your business needs. Virtual Office Angels manages recruitment, onboarding, employment administration, payroll, and ongoing people support, while you manage day-to-day operations.',
  ...
  { path: '/insights', eyebrow: 'Insights', title: 'Practical thinking for building better remote support.', summary: '', template: 'insights',
    image: '/assets/source/staging/images/c88686d2b0-1690.jpg', imageAlt: 'A laptop and notebook set out on a sofa and side table at home' },
  { path: '/videos', eyebrow: 'Videos and resources', title: 'Useful guidance, in a format that is easy to watch.', summary: '', template: 'videos' },
  { path: '/faqs', eyebrow: 'Frequently asked questions', title: 'Straight answers before you get started.', summary: '', template: 'faqs' },
