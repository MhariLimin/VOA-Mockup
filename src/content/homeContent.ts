export const heroStats = [
  ...
  ['100% managed', 'HR, payroll, IT and team support'],
] as const;
...
export const specialistServices = [
  ...
  { title: 'Back Office & Admin', href: '/services/back-office-admin', text: 'Everyday operational support that protects your focus.', image: '/assets/source/staging/images/6f63e14c16-2149013955.jpg', systems: ['Your CRM', 'Microsoft 365 or Google Workspace', 'Task-management tools'] },
